...
public enum MemberDomainErrorCode implements ErrorCode {
    DUPLICATE_EMAIL(HttpStatus.CONFLICT, 1002, "⚠️ 이미 존재하는 이메일입니다."),
    MEMBER_NOT_FOUND(HttpStatus.NOT_FOUND, 1003, "⚠️ 해당 ID의 회원을 찾을 수 없습니다."),
    UNDERAGE_MEMBER(HttpStatus.FORBIDDEN, 1011, "⚠️ 20세 미만은 가입할 수 없습니다."),
